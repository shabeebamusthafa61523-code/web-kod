    ...
    <div className="min-h-screen  flex items-center justify-center p-10">
      ...
      <div className="flex gap-8 flex-wrap justify-center">
        {cards.map((card, i) => (
         <div
  key={i}
  className="group relative w-[300px] h-[360px] rounded-2xl p-[1px] 
  bg-transparent
...
>
            {/* Inner Card */}
           <div className="relative h-full rounded-2xl p-6 flex flex-col justify-between overflow-hidden 
